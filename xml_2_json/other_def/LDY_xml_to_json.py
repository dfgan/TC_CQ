...
if __name__ == '__main__':
    ...
    category_item_id = 1
    annotation_id = 1
    category_set = ['COM01','COM09','COM10','COM22','FLE01','FLE02','FLE03','FLE04','FLE05','FLE06','FLE07','FLE09','FLE10','FLE11','LSP02','LSP09','RES05']


    xml_path = r'D:\whtm\24000\data\24000\24000\train\labels'
    img_path = r'D:\whtm\24000\data\24000\24000\train\images'
    json_file = r'D:\whtm\24000\data\24000\24000\train\train.json'
    parseXmlFiles(xml_path,img_path)
